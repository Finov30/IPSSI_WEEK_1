// Mapping des codes secteurs APE vers libellés
export const SECTEUR_LIBELLES: Record<string, string> = {
...
export const getSecteurLibelle = (code: string | null): string => {
  if (!code) return 'Non renseigné'
  return SECTEUR_LIBELLES[code] || `Secteur ${code}`
}
